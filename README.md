...
[![Live Portfolio](https://img.shields.io/badge/Live_Portfolio-Vercel-E63946?style=for-the-badge&logo=vercel&logoColor=white)](https://portfolio-three-sooty-40.vercel.app)
...
[![Lightroom](https://img.shields.io/badge/Adobe_Lightroom-31A8FF?style=for-the-badge&logo=adobe-lightroom&logoColor=white)](https://www.adobe.com/products/photoshop-lightroom.html)

<br/>

<a href="https://portfolio-three-sooty-40.vercel.app">
  <img src="./public/social-preview.png" alt="Saketh Yadav Portfolio Banner" width="100%" style="border-radius: 8px; border: 1px solid #1f2937;" />
</a>
...
[![Repository](https://img.shields.io/badge/GitHub_Repository-saketh752%2FAI__Fitness__Platform-black?style=for-the-badge&logo=github)](https://github.com/saketh752/AI_Fitness_Platform)
[![Architecture](https://img.shields.io/badge/Architecture-Polyglot_Microservices-E63946?style=for-the-badge)](https://github.com/saketh752/AI_Fitness_Platform)
[![Stack](https://img.shields.io/badge/Stack-Flutter_%7C_Spring_Boot_%7C_FastAPI_%7C_MySQL-005C84?style=for-the-badge)](https://github.com/saketh752/AI_Fitness_Platform)
...
flowchart TB
    subgraph Client ["📱 Client Tier"]
        FlutterApp["Flutter Mobile & Web Client\n(Real-time Video Feed & UI)"]
    end

    subgraph API_Gateway ["🌐 Ingress & Routing"]
        Gateway["Reverse Proxy / API Gateway"]
    end

    subgraph CoreBackend ["☕ Business Core (Spring Boot :8080)"]
        Auth["JWT Authentication & Security"]
        Workout["Workout & Nutrition Engine"]
        Profile["Profile & Progress Tracker"]
        Flyway["Flyway Schema Migrations"]
    end

    subgraph Microservices ["⚡ Intelligence Microservices (Python / FastAPI)"]
        CVService["👁️ CV Kinematics Engine\n(:5000 · MediaPipe & OpenCV)"]
        AgentService["🤖 Autonomous AI Coach\n(:8000 · Llama 3 & Groq API)"]
    end

    subgraph DataStorage ["🗄️ Persistence & Cloud"]
        DB[("MySQL 8.0 Relational DB")]
        LLM["Groq Cloud LLM API"]
    end

    FlutterApp -->|HTTPS / REST| Gateway
    Gateway --> CoreBackend
    CoreBackend -->|JPA / Hibernate| DB
    Flyway -.->|Versioned Migrations| DB
    FlutterApp -->|Video Streams| CVService
    CoreBackend -->|Inter-Service HTTP| CVService
    CoreBackend -->|Inter-Service HTTP| AgentService
    AgentService -->|Prompt Orchestration| LLM
```
